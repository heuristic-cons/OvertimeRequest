sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/getronics/hr/Z_FIORI_OVERTIME/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#OvertimeRequest-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#OvertimeRequest-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.getronics.hr.Z_FIORI_OVERTIME.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/getronics/hr/Z_FIORI_OVERTIME/localService/mockserver"], function (mockserver) {
